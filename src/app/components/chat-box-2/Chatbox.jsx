    ...
    const dummyReply = async () => {
        setTimeout(() => {
            ...
            let messageObject = {
                ...
                avatar: process.env.PUBLIC_URL + '/assets/images/faces/13.jpg',
                name: 'Frank Powell',
            }
        ...
        if (isAlive) {
            setMessageList([
                ...
                },
                {
                    ...
                    name: 'John Doe',
                    avatar: process.env.PUBLIC_URL + '/assets/images/face-1.jpg',
                    status: 'online',
                    mood: '',
                },
                {
        ...
        <div className="flex-column h-full">
            ...
            >
                <div className="flex items-center">
                    <ChatAvatar
                        src={process.env.PUBLIC_URL + '/assets/images/face-2.jpg'}
                        status="online"
                    />
                    <div className="ml-3">
                ...
                <div className="p-5 flex justify-end">
                    <div className="ml-3">
                        <div className="p-2 mb-2 flex justify-end items-center max-w-240 bg-light-gray border-radius-4 text-14">
                            <img
                                className="w-40"
                                src={process.env.PUBLIC_URL + '/assets/images/laptop-1.png'}
                                alt="laptop"
                            />
                            <div className="ml-3">
