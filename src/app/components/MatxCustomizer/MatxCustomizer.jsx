...
const demoLayouts = [
    {
        name: 'Light Sidebar',
        thumbnail: process.env.PUBLIC_URL + '/assets/images/screenshots/layout1-customizer.png',
        isPro: false,
        options: {
    ...
    },
    {
        ...
        thumbnail: process.env.PUBLIC_URL + '/assets/images/screenshots/layout5-customizer.png',
        isPro: false,
        options: {
            activeLayout: 'layout1',
            activeTheme: 'blue',
    ...
    {
        name: 'Dark Sidebar',
        thumbnail: process.env.PUBLIC_URL + '/assets/images/screenshots/layout1-blue-customizer.png',
        isPro: false,
        options: {
            activeLayout: 'layout1',
            activeTheme: 'blue',
    ...
    {
        name: 'Dark Theme',
        thumbnail: process.env.PUBLIC_URL + '/assets/images/screenshots/layout3-customizer.png',
        isPro: true,
        options: {
    ...
    },
    {
        ...
        thumbnail: process.env.PUBLIC_URL + '/assets/images/screenshots/layout4-customizer.png',
        isPro: true,
        options: {
            activeLayout: 'layout2',
            activeTheme: 'purple1',
